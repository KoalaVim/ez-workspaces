...
Support creating sessions that have no associated git worktree. Bare sessions act as lightweight bookmarks or organizational nodes in the session tree without requiring filesystem artifacts. They are useful for grouping child sessions, marking planned work, or organizing non-code tasks.
