...
Support registering and managing directories that are not git repositories. Non-git repos allow ez-workspaces to serve as a general-purpose workspace navigator, with sessions acting as simple directory bookmarks rather than worktree-backed branches.
