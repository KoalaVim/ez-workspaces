# Cursor MCP Approvals

## Purpose

Bundled plugin that auto-approves MCP servers in Cursor IDE for worktree sessions by computing workspace-specific approval IDs and writing them to Cursor's per-project directory, eliminating the per-server approval prompts.
