...
Provide a per-session notes directory with a default README.md for tracking context, TODOs, and other free-form information. Notes are stored in the OS data directory, managed via CLI commands and browser keybinds, and rendered in the fzf preview pane.
