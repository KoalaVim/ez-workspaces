...
The daemon SHALL only refresh PR statuses for sessions whose `ez_pr_gh_user` matches the currently active `gh` user. Sessions with a different or missing `ez_pr_gh_user` SHALL be skipped.
