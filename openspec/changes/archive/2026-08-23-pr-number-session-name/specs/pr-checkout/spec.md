...
- **THEN** session name is set to `pr<number>-<headRefName>` (e.g. `pr42-feature-branch`)
...
- **THEN** session name is set to `pr<number>-<headRefName>`
