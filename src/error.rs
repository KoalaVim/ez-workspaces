...
pub enum EzError {
    ...
    #[error("Session(s) have unchecked TODOs in notes: {sessions:?}. Complete or remove them, or use --force to delete anyway.")]
    SessionHasUncheckedTodos { sessions: Vec<String> },
